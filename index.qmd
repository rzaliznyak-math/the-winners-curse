...
Our experiment hit *Statistical Significance*. We no longer look at all experiments, just those that crossed the significance threshold. How accurate is the observed index-to-control likely to be?


Among statistically significant experiments, we ask:

$$
\Pr\!\left(\widehat{\Delta} > \Delta_{\text{true}} \mid \text{Statistical Significance}\right)
$$

> What share of _alternative distribution_ fell above the _stats sig_ threshold and of those, what share of experiments had averages higher than the true effect?
