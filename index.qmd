...
You ran your A/B test properly: you determined your required sample size in advance, collected all of your data, and calculated a p-value < 0.01 at the end of the experiment.

But **statistical significance is not an endorsement of the observed treatment effect** --- even with a low p-value. The `numpy.random` simulations below show why.
...
Priors are weighed against observed results using precision-weighted averaging, so noisier experimental estimates are shrunk more aggressively toward historical baselines.
...
Statistical significance conditions on extreme results, biasing reported effect sizes upward --- **the Winner’s Curse**.

Even in a properly designed experiment with 80% statistical power, a statistically significant result is more likely to overestimate than underestimate the true delta-to-control — 62.5% of the time.
